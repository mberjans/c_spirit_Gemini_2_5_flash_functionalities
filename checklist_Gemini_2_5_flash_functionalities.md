Here is a detailed checklist of tiny tasks for each software development ticket, including unique IDs and dependencies, with a focus on developing unit tests before implementation and conducting them afterward.
...
* \[ \] **AIM2-ODIE-001-T1:** Initialize Git repository in the project root.  
...
* \[ \] **AIM2-ODIE-002-T1:** **Develop Unit Tests:** Write unit tests (tests/test\_dependencies.py) to verify Poetry installation and basic dependency imports (e.g., poetry run python \-c "import owlready2").  
